...
public class Simulation
{
    ...
    {                
        ...
        System.out.println("Total Cash By Bidders" + bidderAmount);
        System.out.println("Revenue" + server.revenue());
        System.out.println("Sum of HighestBids" + server.returnSumofHighestBids());
        System.out.println("Last Listing ID " + server.returnLastingId());
        System.out.println("Item And ID Size" + server.returnItemSize());
        System.out.println("Size of HighesTbidders" + server.returnHighestBidders());
        System.out.println("Sold Items" + server.soldItemsCount());
        System.out.println("ItemandIDsize" + server.returnItemSize());
        System.out.println("Seller Items" + totalitems);
